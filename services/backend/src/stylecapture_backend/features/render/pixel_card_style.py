...
_PIXEL_CARD_RULES = (
    ...
    "以人物动作的整体外接框居中，保留头顶、鞋底、手部和四周留白，脚下放轻量椭圆地毯。"
    "保留内容图中可见的发型、发饰、眼镜、表情、真实体型、服装版型、主辅色、鞋履和关键配饰；"
    "姿势也是人物内容，不要自动改成双臂垂下的正面立正。优先保留躯干朝向、头部倾斜、四肢弯曲、双臂方向和手部位置；"
    "为容纳伸展动作应缩小人物而不是收回或裁切手臂。若无法完全复现，至少保留主导动作剪影："
    "原本抬起或外伸的手臂仍须抬起或外伸，并保持身体重心，禁止改成僵直对称站姿。"
    "保留胖瘦、肩胯宽度和年龄感，但校正仰拍、俯拍、广角近大远小及裁切造成的比例失真；"
    "成人角色归一到自然的5.5至6.5头身，胯部至鞋底约占站立身高45%至50%。"
    "下半身缺失时按上身尺度补全自然腿长，禁止因裁切生成短腿，也不要统一拉成九头身。"
