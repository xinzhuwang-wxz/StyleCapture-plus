...
| `photo.pixel_trial` | pixel_trial | `/v1/pixel-trials*` | LiteLLM `image_generation` | `pixel_trial/processing.py` | 产品能力，Skill facade 可补 |
| `look.pixel_cover` | render | Look render API/Worker | LiteLLM `image_generation` | `render/processing.py`, `signatures.py` | 产品能力，随 Look 详情调用 |
