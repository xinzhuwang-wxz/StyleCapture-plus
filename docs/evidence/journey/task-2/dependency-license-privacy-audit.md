...
| `grdb.swift` | `7.11.1` | `b83108d10f42680d78f23fe4d4d80fc88dab3212` | MIT | No SDK privacy manifest found/required for this source package at Task 2; app manifest declares no tracking or collected data. |
...
| `swift-composable-architecture` | `1.26.1` | `ead11e04e5011c437722c1990d22f80d87056978` | MIT | No SDK privacy manifest found/required for this source package at Task 2; app manifest declares no tracking or collected data. |
...
| `swift-sharing` | `2.9.1` | `8244fe63bf43e58188ab13851ad693eecf6a9e90` | MIT | No SDK privacy manifest found/required for this source package at Task 2; app manifest declares no tracking or collected data. |
...
SDK privacy manifest note: no third-party binary SDK is introduced in Task 2. SwiftPM source packages are compiled from source; release privacy manifest inspection remains blocked until an iOS archive can be produced on a host with an installed iOS simulator/runtime or signing archive path.
