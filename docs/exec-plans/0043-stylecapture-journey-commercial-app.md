...
- [ ] Task 2 review-fix round 1 GREEN: pending hosted product/iOS verification after reducer, privacy manifest, package-graph evidence and evidence-log cleanup fixes.
